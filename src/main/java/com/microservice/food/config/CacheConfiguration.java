package com.microservice.food.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.microservice.food.domain.Platillo.class.getName() + ".extrasPlatillos");
            createCache(cm, com.microservice.food.domain.ExtrasPlatillo.class.getName());
            createCache(cm, com.microservice.food.domain.Extra.class.getName());
            createCache(cm, com.microservice.food.domain.Extra.class.getName() + ".extrasPlatillos");
            ...
            createCache(cm, com.microservice.food.domain.Platillo.class.getName() + ".complementosPlatillos");
            createCache(cm, com.microservice.food.domain.ComplementosPlatillo.class.getName());
            createCache(cm, com.microservice.food.domain.Complemento.class.getName());
            createCache(cm, com.microservice.food.domain.Complemento.class.getName() + ".complementosPlatillos");
